...
export default function CATCalculatorPage() {
  ...
  // Simulation of CAT calculation (Approximation for demo purposes)
  // In a real banking app, this would use an IRR (Internal Rate of Return) function
  // based on an exact amortization schedule.
